...
import { setLanguage } from "@/store/slices/codeEditorSlice";
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="group relative flex items-center gap-3 px-4 py-2.5 sm:px-4 sm:py-2 bg-[#1e1e2e]/80 
      ...
      >
        ...
        <span className="text-gray-200 text-left group-hover:text-white transition-colors flex-1 truncate">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full sm:w-72 md:w-80 bg-[#1e1e2e]/95 backdrop-blur-xl
